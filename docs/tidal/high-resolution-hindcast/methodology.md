...
Value-Added Products (VAPs) are computed from the standardized data. Each variable in the [Variables](variables.md) section documents its specific derivation equation. General methods include:
